...
INTEGER(KIND=JPIM) :: MSP   = - HUGE(1_JPIM)
! MGPPCF  - pointer useful for PC scheme
INTEGER(KIND=JPIM) :: MGPPCF_U = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_V = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_T = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_SPD = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_SVD = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_NHX = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_SP = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_CP = - HUGE(1_JPIM)
! MGPPCF  - pointers useful for EC_split_Physics 
INTEGER(KIND=JPIM) :: MGPPCF_UP = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_VP = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_TP = - HUGE(1_JPIM)
! MGPPCF  - pointers useful for PC scheme
INTEGER(KIND=JPIM) :: MGPPCF_BBC = - HUGE(1_JPIM)
INTEGER(KIND=JPIM) :: MGPPCF_DPHI = - HUGE(1_JPIM)
...
TYPE TYPE_GP
! Number of grid-point GMV fields
INTEGER(KIND=JPIM) :: NDIM  = 0   
