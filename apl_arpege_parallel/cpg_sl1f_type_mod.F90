...
TYPE CPG_SL1F_TYPE
  ...
  TYPE (CPG_SL1F_3D_TYPE) :: HLMF
  TYPE (CPG_SL1F_3D_TYPE) :: HIMF
  ...
  TYPE (CPG_SL1F_3D_TYPE) :: WMFC
  TYPE (CPG_SL1F_3D_TYPE) :: HLCFMF
  TYPE (CPG_SL1F_3D_TYPE) :: HICFMF
...
IF (COND (YDMODEL%YRML_GCONF%YGFL%YHLMF, YDMODEL)) THEN
  YDVARS_LIST (IPNTR) = YDCPG_SL1F%HLMF
  IPNTR = IPNTR + 1
ENDIF
IF (COND (YDMODEL%YRML_GCONF%YGFL%YHIMF, YDMODEL)) THEN
  YDVARS_LIST (IPNTR) = YDCPG_SL1F%HIMF
  IPNTR = IPNTR + 1
ENDIF
...
IF (COND (YDMODEL%YRML_GCONF%YGFL%YMO, YDMODEL)) THEN
  YDVARS_LIST (IPNTR) = YDCPG_SL1F%MO
  IPNTR = IPNTR + 1
ENDIF
...
IF (COND (YDMODEL%YRML_GCONF%YGFL%YTHRAD, YDMODEL)) THEN
  YDVARS_LIST (IPNTR) = YDCPG_SL1F%THRAD
  IPNTR = IPNTR + 1
ENDIF
    
END SUBROUTINE GREPVARSF 
...
END SUBROUTINE CPG_SL1F_2D_TYPE_SYNC_HOST  
...
END SUBROUTINE CPG_SL1F_3D_TYPE_SYNC_HOST
...
END FUNCTION CPG_SL1F_TYPE_CONFORM
...
END SUBROUTINE CPG_SL1F_TYPE_RESIZE
...
END SUBROUTINE CPG_SL1F_TYPE_SET_HOST_PARALLEL
...
END SUBROUTINE CPG_SL1F_TYPE_SET_DEVICE_PARALLEL




END MODULE CPG_SL1F_TYPE_MOD
