...
! JPAERO : Number of active aerosol fields - 3D CAMS n.r.t aerosols
! JPAEROMASS2D : Number of 2D CAMS climatological aerosols
...
INTEGER(KIND=JPIM), PARAMETER :: JPAEROMASS2D=11
