...
CONTAINS
  ...
  SUBROUTINE FIELD_4RD_GANG_WRAPPER_INIT(SELF, DATA, PERSISTENT, LBOUNDS, MAP_DEVPTR, SYNC_ON_FINAL, INITIALIZED)
  ...
  SUBROUTINE FIELD_4RD_GANG_OWNER_INIT(SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED, INIT_VALUE, PINNED, MAP_DEVPTR, POOLED)
  ...
  SUBROUTINE FIELD_4RD_GANG_WRAPPER_FINAL(SELF)
    ...
    CLASS (FIELD_3RD_WRAPPER_HELPER), POINTER :: YLF
