...
!>REAL(KIND=JPRB)          :: PVOL (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PSS1(:)   ! cams aerosol small sea salt
!>REAL(KIND=JPRB)          :: PSS1 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PSS2(:)   ! cams aerosol medium sea salt
!>REAL(KIND=JPRB)          :: PSS2 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PSS3(:)   ! cams aerosol large sea salt
!>REAL(KIND=JPRB)          :: PSS3 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PDD1(:)   ! cams aerosol small desert dust
!>REAL(KIND=JPRB)          :: PDD1 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PDD2(:)   ! cams aerosol medium desert dust
!>REAL(KIND=JPRB)          :: PDD2 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PDD3(:)   ! cams aerosol large desert dust
!>REAL(KIND=JPRB)          :: PDD3 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: POM1(:)   ! cams aerosol hydrophilic organic matter
!>REAL(KIND=JPRB)          :: POM1 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: POM2(:)   ! cams aerosol hydrophobic organic matter
!>REAL(KIND=JPRB)          :: POM2 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PBC1(:)   ! cams aerosol hydrophilic black carbon
!>REAL(KIND=JPRB)          :: PBC1 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PBC2(:)   ! cams aerosol hydrophobic black carbon
!>REAL(KIND=JPRB)          :: PBC2 (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PSU(:)   ! cams aerosol sulfates
!>REAL(KIND=JPRB)          :: PSU (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PGROUP(:,:)
...
!>REAL(KIND=JPRB)          :: PCLK (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PUSTRW(:)   ! Ocean surface stress U-component passed to the wave model (WAM).
!>REAL(KIND=JPRB)          :: PUSTRW (YDCPG_OPTS%KLON)
  REAL(KIND=JPRB), POINTER :: PVSTRW(:)   ! Ocean surface stress V-component passed to the wave model (WAM).
!>REAL(KIND=JPRB)          :: PVSTRW (YDCPG_OPTS%KLON)
...
!>REAL(KIND=JPRB)          :: PVCURW (YDCPG_OPTS%KLON)
  ...
  CLASS (FIELD_2RB), POINTER :: F_CLK=>NULL()
  CLASS (FIELD_2RB), POINTER :: F_USTRW=>NULL()
  CLASS (FIELD_2RB), POINTER :: F_VSTRW=>NULL()
...
TYPE SURFACE_VIEW_GROUP_VEXTRDI
  TYPE(FIELD_3RB_VIEW), ALLOCATABLE, DIMENSION(:) :: PXA   ! None
...
!>REAL(KIND=JPRB)          :: PXEDR (YDCPG_OPTS%KLON, YDCPG_OPTS%YRSURF_DIMS%YSD_DID%NLEVS)
  ...
  TYPE (FIELD_3RB_PTR), ALLOCATABLE, DIMENSION(:) :: F_XA
...
CONTAINS
  ...
  SUBROUTINE SURFACE_VIEW_GROUP_VCLIA_INIT(SELF, VARIABLE_GROUP)
    ...
    SELF%F_SS1 => VARIABLE_GROUP%VSS1%FT0
    SELF%F_SS2 => VARIABLE_GROUP%VSS2%FT0
    SELF%F_SS3 => VARIABLE_GROUP%VSS3%FT0
    SELF%F_DD1 => VARIABLE_GROUP%VDD1%FT0
    SELF%F_DD2 => VARIABLE_GROUP%VDD2%FT0
    SELF%F_DD3 => VARIABLE_GROUP%VDD3%FT0
    SELF%F_OM1 => VARIABLE_GROUP%VOM1%FT0
    SELF%F_OM2 => VARIABLE_GROUP%VOM2%FT0
    SELF%F_BC1 => VARIABLE_GROUP%VBC1%FT0
    SELF%F_BC2 => VARIABLE_GROUP%VBC2%FT0
    SELF%F_SU => VARIABLE_GROUP%VSU%FT0
    SELF%VARIABLE_GROUP => VARIABLE_GROUP
    SELF%F_GROUP => VARIABLE_GROUP%F_GROUP
  ...
  SUBROUTINE SURFACE_VIEW_GROUP_WAM_INIT(SELF, VARIABLE_GROUP)
    ...
    SELF%F_CLK => VARIABLE_GROUP%VCLK%FT0
    SELF%F_USTRW => VARIABLE_GROUP%VUSTRW%FT0
    SELF%F_VSTRW => VARIABLE_GROUP%VVSTRW%FT0
  ...
  SUBROUTINE SURFACE_VIEW_GROUP_VEXTRDI_INIT(SELF, VARIABLE_GROUP)
    ...
    ! Create a view for the "T0" field only for diagnostic fields
    IF (ALLOCATED(VARIABLE_GROUP%VXA)) THEN
      ALLOCATE(SELF%PXA(SIZE(VARIABLE_GROUP%VXA)))
      ALLOCATE(SELF%F_XA(SIZE(VARIABLE_GROUP%VXA)))
      DO I=1, SIZE(VARIABLE_GROUP%VXA)
      END DO
    END IF
  ...
  SUBROUTINE SURFACE_VIEW_GROUP_VEXTRDI_FINAL (SELF)
    ...
    IF (ALLOCATED (SELF%PXA)) DEALLOCATE (SELF%PXA)
    IF (ALLOCATED (SELF%F_XA)) DEALLOCATE (SELF%F_XA)
