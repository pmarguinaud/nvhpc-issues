...
CONTAINS
  ...
  PROCEDURE :: FIELD_REGISTRY_CREATE_VARIABLE_WRAP_2RB
  PROCEDURE :: FIELD_REGISTRY_CREATE_VARIABLE_WRAP_3RB
  PROCEDURE :: FIELD_REGISTRY_CREATE_VARIABLE_WRAP_4RB
  ...
  GENERIC   :: CREATE_VARIABLE => &
   ...
   & FIELD_REGISTRY_CREATE_VARIABLE_WRAP_2RB, &
   & FIELD_REGISTRY_CREATE_VARIABLE_WRAP_3RB, &
   & FIELD_REGISTRY_CREATE_VARIABLE_WRAP_4RB
...
!   CLASS(FIELD_2IM), POINTER, INTENT(INOUT) :: FIELD_PTR
...
! END FUNCTION CREATE_FIELD_EMPTY_4D
  ...
  SUBROUTINE FIELD_REGISTRY_REGISTER_GFL_FIELDS(SELF, VARIABLES, GFL_ARRAY, GFL_META, YDMODEL)
    ...
    VARIABLES%HLMF = SELF%CREATE_VARIABLE('HLMF', GFL_META%YHLMF, GFL_ARRAY)
    VARIABLES%HIMF = SELF%CREATE_VARIABLE('HIMF', GFL_META%YHIMF, GFL_ARRAY)
    ...
    VARIABLES%WMFC = SELF%CREATE_VARIABLE('WMFC', GFL_META%YWMFC, GFL_ARRAY)
    VARIABLES%HLCFMF = SELF%CREATE_VARIABLE('HLCFMF', GFL_META%YHLCFMF, GFL_ARRAY)
    VARIABLES%HICFMF = SELF%CREATE_VARIABLE('HICFMF', GFL_META%YHICFMF, GFL_ARRAY)
    ...
    VARIABLES%MO = SELF%CREATE_VARIABLE('MO', GFL_META%YMO, GFL_ARRAY)
    ...
    VARIABLES%THRAD = SELF%CREATE_VARIABLE('THRAD', GFL_META%YTHRAD, GFL_ARRAY)
   ...
   IPNTR = 1
    ...
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%HLMF
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%HIMF
    IPNTR = IPNTR + 1
    ...
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%WMFC
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%HLCFMF
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%HICFMF
    IPNTR = IPNTR + 1
    ...
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%MO
    IPNTR = IPNTR + 1
    ...
    DO JFLD = 1, SIZE (VARIABLES%EXT)
      ...
      IPNTR = IPNTR + 1
    ENDDO
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%THRAD
    IPNTR = IPNTR + 1
  ...
  SUBROUTINE FIELD_REGISTRY_REGISTER_SURFACE_FIELDS(SELF, SURFVARS, YDSURF, PERSISTENT)
    ...
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_SS1', &
     & VARIABLE=SURFVARS%GSD_VA%VSS1, ARRAY=SD_VA, &
     & META=YSD_VA%YSS1, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YSS1))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_SS2', &
     & VARIABLE=SURFVARS%GSD_VA%VSS2, ARRAY=SD_VA, &
     & META=YSD_VA%YSS2, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YSS2))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_SS3', &
     & VARIABLE=SURFVARS%GSD_VA%VSS3, ARRAY=SD_VA, &
     & META=YSD_VA%YSS3, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YSS3))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_DD1', &
     & VARIABLE=SURFVARS%GSD_VA%VDD1, ARRAY=SD_VA, &
     & META=YSD_VA%YDD1, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YDD1))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_DD2', &
     & VARIABLE=SURFVARS%GSD_VA%VDD2, ARRAY=SD_VA, &
     & META=YSD_VA%YDD2, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YDD2))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_DD3', &
     & VARIABLE=SURFVARS%GSD_VA%VDD3, ARRAY=SD_VA, &
     & META=YSD_VA%YDD3, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YDD3))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_OM1', &
     & VARIABLE=SURFVARS%GSD_VA%VOM1, ARRAY=SD_VA, &
     & META=YSD_VA%YOM1, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YOM1))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_OM2', &
     & VARIABLE=SURFVARS%GSD_VA%VOM2, ARRAY=SD_VA, &
     & META=YSD_VA%YOM2, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YOM2))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_BC1', &
     & VARIABLE=SURFVARS%GSD_VA%VBC1, ARRAY=SD_VA, &
     & META=YSD_VA%YBC1, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YBC1))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_BC2', &
     & VARIABLE=SURFVARS%GSD_VA%VBC2, ARRAY=SD_VA, &
     & META=YSD_VA%YBC2, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YBC2))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VA_SU', &
     & VARIABLE=SURFVARS%GSD_VA%VSU, ARRAY=SD_VA, &
     & META=YSD_VA%YSU, DESCR=YSD_VAD, &
     & ACTIVE=ASSOCIATED(YSD_VA%YSU))
    ...
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_USTRW', &
     & VARIABLE=SURFVARS%GSD_WW%VUSTRW, ARRAY=SD_WW, &
     & META=YSD_WW%YUSTRW, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YUSTRW))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_VSTRW', &
     & VARIABLE=SURFVARS%GSD_WW%VVSTRW, ARRAY=SD_WW, &
     & META=YSD_WW%YVSTRW, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YVSTRW))
    ...
    IF (ASSOCIATED(YSD_DI%YXA)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_3RB(NAME='SD_DI_XA', &
       & VARIABLES=SURFVARS%GSD_DI%VXA, ARRAY=SD_DI, &
       & META=YSD_DI%YXA(:), DESCR=YSD_DID, &
       & ACTIVE=ASSOCIATED(YSD_DI%YXA))
    END IF
