...
INTERFACE SGET_DEVICE_DATA_RDONLY
  MODULE PROCEDURE :: SGET_DEVICE_DATA_RDONLY_FIELD_5LM
...
INTERFACE SGET_HOST_DATA_RDONLY
  MODULE PROCEDURE :: SGET_HOST_DATA_RDONLY_FIELD_5LM
...
INTERFACE SGET_DEVICE_DATA_RDWR
  MODULE PROCEDURE :: SGET_DEVICE_DATA_RDWR_FIELD_5LM
...
INTERFACE SGET_HOST_DATA_RDWR
  MODULE PROCEDURE :: SGET_HOST_DATA_RDWR_FIELD_5LM
...
CONTAINS
  ...
  SUBROUTINE SGET_DEVICE_DATA_RDONLY_FIELD_5LM (PTR, FIELD_PTR) 

    CLASS (FIELD_5LM), POINTER, OPTIONAL :: FIELD_PTR
    LOGICAL(KIND=JPLM), POINTER :: PTR(:,:,:,:,:)

  END SUBROUTINE SGET_DEVICE_DATA_RDONLY_FIELD_5LM
  ...
  SUBROUTINE SGET_HOST_DATA_RDONLY_FIELD_5LM (PTR, FIELD_PTR) 

    CLASS (FIELD_5LM), POINTER, OPTIONAL :: FIELD_PTR
    LOGICAL(KIND=JPLM), POINTER :: PTR(:,:,:,:,:)

  END SUBROUTINE SGET_HOST_DATA_RDONLY_FIELD_5LM
  ...
  SUBROUTINE SGET_DEVICE_DATA_RDWR_FIELD_5LM (PTR, FIELD_PTR) 

    CLASS (FIELD_5LM), POINTER, OPTIONAL :: FIELD_PTR
    LOGICAL(KIND=JPLM), POINTER :: PTR(:,:,:,:,:)

  END SUBROUTINE SGET_DEVICE_DATA_RDWR_FIELD_5LM
  ...
  SUBROUTINE SGET_HOST_DATA_RDWR_FIELD_5LM (PTR, FIELD_PTR) 

    CLASS (FIELD_5LM), POINTER, OPTIONAL :: FIELD_PTR
    LOGICAL(KIND=JPLM), POINTER :: PTR(:,:,:,:,:)

  END SUBROUTINE SGET_HOST_DATA_RDWR_FIELD_5LM
