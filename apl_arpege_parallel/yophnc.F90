...
! LEGWDG2   : TRUE IF SIMPLIFIED OROGRAPHY SCHEME ACTIVATED IN TL AND AD
! LEGWDGF2  : TRUE IF FULL (NOT ONLY LOW-LEVEL BLOCKING) GWD ACTIVATED in TL/AD
...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LEGWDGF2 = ', SELF%LEGWDGF2
