...
& YDMF_PHYS_SURF, YDVARS, YDGEOMVARS, YDMODEL, PFLU_NEIJ, PNEBS, PNEB_CVPP, PQC_DET_PCMT, PQI, PQL, PQLIS, &
...
SUBROUTINE APL_ARPEGE_PRECIPITATION_PARALLEL (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS&
&, YDMF_PHYS, YDMF_PHYS_SURF, YDVARS, YDGEOMVARS, YDMODEL, YD_PFLU_NEIJ, YD_PNEBS,&
& YD_PNEB_CVPP, YD_PQC_DET_PCMT, YD_PQI, YD_PQL, YD_PQLIS, YD_PQLI_CVPP, YD_PQR, YD_PQS&
&, YD_PQV, YD_PSEDIQI, YD_PSEDIQL, YD_PTENHA, YD_PTENQVA, YDSTA)
