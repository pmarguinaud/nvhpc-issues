...
!     ------------------------------------------------------------------
! WARNING ! The use of the new optional argument LDDUM is highly discouraged
!           because it violates the purpose of this module which is to allow
!           the whole code to be compiled with bounds violation checking,
!           by forbidding uninitialized fields adresses in arrays.
!           Anyway, this module will become obsolete with the new fields layout
!           but meanwhile it must continue to fulfill its role. REK.
!     ------------------------------------------------------------------
