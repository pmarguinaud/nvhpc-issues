...
& PUCLS,PVCLS,PU,PV,PCAPE,KCBOT,PDCAPE,PTKE,PAPHIFM,POROG,&
...
&, YDTOPH, KIDIA, KFDIA, KLON, KLEV, PUCLS, PVCLS, PU, PV, PCAPE, KCBOT,&
& PDCAPE, PTKE, PAPHIFM, POROG, PUGST, PVGST, PBLH, KCLPH, YDSTACK)
USE PARKIND1,ONLY:JPIM, JPRB
USE YOMPHY,ONLY:TPHY
USE YOMPHY2,ONLY:TPHY2
USE YOMCST,ONLY:TCST
