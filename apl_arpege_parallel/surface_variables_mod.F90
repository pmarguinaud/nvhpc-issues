...
TYPE SURFACE_VARIABLE_GROUP_VCLIA
  ...
  TYPE(VARIABLE_2RB) :: VSS1   ! cams aerosol small sea salt
  TYPE(VARIABLE_2RB) :: VSS2   ! cams aerosol medium sea salt
  TYPE(VARIABLE_2RB) :: VSS3   ! cams aerosol large sea salt
  TYPE(VARIABLE_2RB) :: VDD1   ! cams aerosol small desert dust
  TYPE(VARIABLE_2RB) :: VDD2   ! cams aerosol medium desert dust
  TYPE(VARIABLE_2RB) :: VDD3   ! cams aerosol large desert dust
  TYPE(VARIABLE_2RB) :: VOM1   ! cams aerosol hydrophilic organic matter
  TYPE(VARIABLE_2RB) :: VOM2   ! cams aerosol hydrophobic organic matter
  TYPE(VARIABLE_2RB) :: VBC1   ! cams aerosol hydrophilic black carbon
  TYPE(VARIABLE_2RB) :: VBC2   ! cams aerosol hydrophobic black carbon
  TYPE(VARIABLE_2RB) :: VSU   ! cams aerosol sulfates
...
TYPE SURFACE_VARIABLE_GROUP_WAM
  ...
  TYPE(VARIABLE_2RB) :: VUSTRW   ! Ocean surface stress U-component passed to the wave model (WAM).
  TYPE(VARIABLE_2RB) :: VVSTRW   ! Ocean surface stress V-component passed to the wave model (WAM).
...
TYPE SURFACE_VARIABLE_GROUP_VEXTRDI
  ! Diagnostic surface variable group
  TYPE(VARIABLE_3RB), ALLOCATABLE, DIMENSION(:) :: VXA   ! None
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_SOILB_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_SNOWG_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_LAKEB_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_RESVR_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_CLS_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_OML_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_EXTRP_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_XTRP2_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_CANRI_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VARSF_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VCLIH_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VCLIK_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VCLIP_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VCLIV_FINAL
...
INTEGER (KIND=JPIM) :: I1, I2
  ...
  CALL SELF%VSS1%FINAL
  CALL SELF%VSS2%FINAL
  CALL SELF%VSS3%FINAL
  CALL SELF%VDD1%FINAL
  CALL SELF%VDD2%FINAL
  CALL SELF%VDD3%FINAL
  CALL SELF%VOM1%FINAL
  CALL SELF%VOM2%FINAL
  CALL SELF%VBC1%FINAL
  CALL SELF%VBC2%FINAL
  CALL SELF%VSU%FINAL


END SUBROUTINE SURFACE_VARIABLE_GROUP_VCLIA_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VCLIN_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VDIAGO2_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VDIAGO3_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VDIAG_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_SATSIM_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_WAVES_FINAL
...
INTEGER (KIND=JPIM) :: I1, I2
  ...
  CALL SELF%VCLK%FINAL
  CALL SELF%VUSTRW%FINAL
  CALL SELF%VVSTRW%FINAL
  CALL SELF%VUCURW%FINAL
  CALL SELF%VVCURW%FINAL


END SUBROUTINE SURFACE_VARIABLE_GROUP_WAM_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_PRECFRAC_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VEXTRA_FINAL
...
INTEGER (KIND=JPIM) :: I1, I2
  ...
  IF (ALLOCATED (SELF%VXA)) THEN
    DO I1 = 1, SIZE (SELF%VXA, 1)
      CALL SELF%VXA(I1)%FINAL
    ENDDO
  ENDIF
  CALL SELF%VXEDR%FINAL


END SUBROUTINE SURFACE_VARIABLE_GROUP_VEXTRDI_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VPRECIP_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VPRECIP2_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VEXTR2_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_SFORC_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_SFLUX_FINAL
...
END SUBROUTINE SURFACE_VARIABLE_GROUP_VO3ABC_FINAL
...
END SUBROUTINE SURFACE_VARIABLES_FINAL
