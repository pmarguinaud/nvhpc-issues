...
!  MGPPCF_SPPTCLEARP - pointer for unperturbed clearsky radiation from previous timestep.
...
INTEGER(KIND=JPIM) :: MGPPCF_SPPTCLEARP
...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'MGPPCF_SPPTCLEARP = ', SELF%MGPPCF_SPPTCLEARP
