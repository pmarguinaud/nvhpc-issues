...
INTEGER, PRIVATE, PARAMETER :: JPIM = 4, JPRB = 8
...
REAL(KIND=JPRB),ALLOCATABLE:: RDHIGFLQ(:,:,:)
REAL(KIND=JPRB),ALLOCATABLE:: RDHIGFLO3(:,:,:)
REAL(KIND=JPRB),ALLOCATABLE:: RDHIGFLL(:,:,:)
REAL(KIND=JPRB),ALLOCATABLE:: RDHIGFLI(:,:,:)
