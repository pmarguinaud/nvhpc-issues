...
CONTAINS
  ...
  PROCEDURE :: GET_DEVICE_DATA_WRONLY => FIELD_2RD_GET_DEVICE_DATA_WRONLY
  ...
  PROCEDURE :: SYNC_DEVICE_WRONLY => FIELD_2RD_SYNC_DEVICE_WRONLY
  PROCEDURE :: COPY_OBJECT => FIELD_2RD_COPY_OBJECT
  PROCEDURE :: WIPE_OBJECT => FIELD_2RD_WIPE_OBJECT
  PROCEDURE :: GET_DIMS => FIELD_2RD_GET_DIMS
  ...
  PROCEDURE :: CRC64 => FIELD_2RD_CRC64
#ifdef __PGI
...
CONTAINS
  ...
  PROCEDURE, PRIVATE :: CREATE_HOST_DATA => FIELD_2RD_OWNER_CREATE_HOST_DATA
...
CONTAINS
  ...
  SUBROUTINE FIELD_2RD_WRAPPER_INIT(SELF, DATA, PERSISTENT, LBOUNDS, MAP_DEVPTR, SYNC_ON_FINAL, INITIALIZED)
  ...
  SUBROUTINE FIELD_2RD_OWNER_INIT (SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED, INIT_VALUE, PINNED, MAP_DEVPTR, POOLED)
  ...
  SUBROUTINE FIELD_2RD_OWNER_CREATE_HOST_DATA (SELF)
    ! Create FIELD object by explicitly allocating new data
    CLASS(FIELD_2RD_OWNER) :: SELF

  END SUBROUTINE FIELD_2RD_OWNER_CREATE_HOST_DATA
...
!   thread has moved them meanwhile. And if they are still not, then they are moved.
  ...
  INTEGER*8 FUNCTION FIELD_2RD_CRC64 (SELF) RESULT (ICRC)
    CLASS(FIELD_2RD) :: SELF
    REAL(KIND=JPRD), POINTER :: PTR(:,:)
  ...
  SUBROUTINE FIELD_2RD_GET_DEVICE_DATA_WRONLY (SELF, PPTR, QUEUE)
    CLASS(FIELD_2RD) :: SELF
    REAL(KIND=JPRD), POINTER,         INTENT(INOUT) :: PPTR(:,:)
    INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE

  END SUBROUTINE FIELD_2RD_GET_DEVICE_DATA_WRONLY

  SUBROUTINE FIELD_2RD_SYNC_DEVICE_WRONLY (SELF, QUEUE)
    CLASS(FIELD_2RD) :: SELF
    INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
    REAL(KIND=JPRD), POINTER :: PPTR(:,:)

  END SUBROUTINE FIELD_2RD_SYNC_DEVICE_WRONLY
