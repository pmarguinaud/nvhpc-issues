...
CONTAINS
  ...
  PROCEDURE :: SYNC_DEVICE_WRONLY => FIELD_2LM_SYNC_DEVICE_WRONLY
  PROCEDURE :: COPY_OBJECT => FIELD_2LM_COPY_OBJECT
  PROCEDURE :: WIPE_OBJECT => FIELD_2LM_WIPE_OBJECT
  PROCEDURE :: GET_DIMS => FIELD_2LM_GET_DIMS
...
!   thread has moved them meanwhile. And if they are still not, then they are moved.
  ...
  INTEGER*8 FUNCTION FIELD_2LM_CRC64 (SELF) RESULT (ICRC)
    CLASS(FIELD_2LM) :: SELF
    LOGICAL(KIND=JPLM), POINTER :: PTR(:,:)
  ...
  SUBROUTINE FIELD_2LM_SYNC_DEVICE_WRONLY (SELF, QUEUE)
    CLASS(FIELD_2LM) :: SELF
    INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
    LOGICAL(KIND=JPLM), POINTER :: PPTR(:,:)

  END SUBROUTINE FIELD_2LM_SYNC_DEVICE_WRONLY
