...
CONTAINS
  ...
  PROCEDURE :: SYNC_DEVICE_WRONLY => FIELD_1LM_SYNC_DEVICE_WRONLY
  PROCEDURE :: COPY_OBJECT => FIELD_1LM_COPY_OBJECT
  PROCEDURE :: WIPE_OBJECT => FIELD_1LM_WIPE_OBJECT
  PROCEDURE :: GET_DIMS => FIELD_1LM_GET_DIMS
...
CONTAINS
  ...
  SUBROUTINE FIELD_1LM_SYNC_DEVICE_WRONLY (SELF, QUEUE)
    CLASS(FIELD_1LM) :: SELF
    INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
    LOGICAL(KIND=JPLM), POINTER :: PPTR(:)

  END SUBROUTINE FIELD_1LM_SYNC_DEVICE_WRONLY
