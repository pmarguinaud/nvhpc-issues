...
INTERFACE FIELD_NEW
  ...
  MODULE PROCEDURE FIELD_2RM_NEW_STACK_WRAPPER
  MODULE PROCEDURE FIELD_2RM_NEW_STACK_OWNER
END INTERFACE

INTERFACE

MODULE SUBROUTINE FIELD_2RM_NEW_STACK_WRAPPER (FIELD_PTR, LSTACK, DATA, LBOUNDS, PERSISTENT, SYNC_ON_FINAL, INITIALIZED, &
...
MODULE SUBROUTINE FIELD_2RM_NEW_STACK_OWNER (FIELD_PTR, LSTACK, UBOUNDS, LBOUNDS, PERSISTENT, DELAYED, INIT_VALUE, &
...
MODULE SUBROUTINE FIELD_2RM_GET_STACK_MEMBER_0(SELF, IDX, MEMBER)
  CLASS(FIELD_2RM), INTENT(IN) :: SELF
  INTEGER(KIND=JPIM), INTENT(IN) :: IDX
  CLASS(FIELD_1RM), POINTER, INTENT(INOUT) :: MEMBER

END SUBROUTINE FIELD_2RM_GET_STACK_MEMBER_0

MODULE SUBROUTINE FIELD_2RM_GET_STACK_MEMBER_1(SELF, IDX, MEMBER)
  CLASS(FIELD_2RM), INTENT(IN) :: SELF
  INTEGER(KIND=JPIM), INTENT(IN) :: IDX
  CLASS(FIELD_2RM), POINTER, INTENT(INOUT) :: MEMBER

END SUBROUTINE FIELD_2RM_GET_STACK_MEMBER_1
...
INTERFACE GET_STACK_MEMBER
  MODULE PROCEDURE FIELD_2RM_GET_STACK_MEMBER_0
  MODULE PROCEDURE FIELD_2RM_GET_STACK_MEMBER_1
