...
CONTAINS
  ...
  PROCEDURE :: GET_DEVICE_DATA_WRONLY => FIELD_4IM_GET_DEVICE_DATA_WRONLY
  ...
  PROCEDURE :: SYNC_DEVICE_WRONLY => FIELD_4IM_SYNC_DEVICE_WRONLY
  PROCEDURE :: COPY_OBJECT => FIELD_4IM_COPY_OBJECT
  PROCEDURE :: WIPE_OBJECT => FIELD_4IM_WIPE_OBJECT
  PROCEDURE :: GET_DIMS => FIELD_4IM_GET_DIMS
  ...
  PROCEDURE :: CRC64 => FIELD_4IM_CRC64
#ifdef __PGI
...
CONTAINS
  ...
  PROCEDURE, PRIVATE :: CREATE_HOST_DATA => FIELD_4IM_OWNER_CREATE_HOST_DATA
...
CONTAINS
  ...
  SUBROUTINE FIELD_4IM_WRAPPER_INIT(SELF, DATA, PERSISTENT, LBOUNDS, MAP_DEVPTR, SYNC_ON_FINAL, INITIALIZED)
  ...
  SUBROUTINE FIELD_4IM_OWNER_INIT (SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED, INIT_VALUE, PINNED, MAP_DEVPTR, POOLED)
  ...
  SUBROUTINE FIELD_4IM_OWNER_CREATE_HOST_DATA (SELF)
    ! Create FIELD object by explicitly allocating new data
    CLASS(FIELD_4IM_OWNER) :: SELF

  END SUBROUTINE FIELD_4IM_OWNER_CREATE_HOST_DATA
...
!   thread has moved them meanwhile. And if they are still not, then they are moved.
  ...
  INTEGER*8 FUNCTION FIELD_4IM_CRC64 (SELF) RESULT (ICRC)
    CLASS(FIELD_4IM) :: SELF
    INTEGER(KIND=JPIM), POINTER :: PTR(:,:,:,:)
  ...
  SUBROUTINE FIELD_4IM_GET_DEVICE_DATA_WRONLY (SELF, PPTR, QUEUE)
    CLASS(FIELD_4IM) :: SELF
    INTEGER(KIND=JPIM), POINTER,         INTENT(INOUT) :: PPTR(:,:,:,:)
    INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE

  END SUBROUTINE FIELD_4IM_GET_DEVICE_DATA_WRONLY

  SUBROUTINE FIELD_4IM_SYNC_DEVICE_WRONLY (SELF, QUEUE)
    CLASS(FIELD_4IM) :: SELF
    INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
    INTEGER(KIND=JPIM), POINTER :: PPTR(:,:,:,:)

  END SUBROUTINE FIELD_4IM_SYNC_DEVICE_WRONLY
