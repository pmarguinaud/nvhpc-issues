...
TYPE, ABSTRACT, EXTENDS (FIELD_BASIC) :: FIELD_3LM
  ...
  LOGICAL(KIND=JPLM), POINTER :: DEVPTR(:,:,:) => NULL()
#else
...
CONTAINS
  ...
  PROCEDURE :: SYNC_DEVICE_WRONLY => FIELD_3LM_SYNC_DEVICE_WRONLY
  PROCEDURE :: COPY_OBJECT => FIELD_3LM_COPY_OBJECT
  PROCEDURE :: WIPE_OBJECT => FIELD_3LM_WIPE_OBJECT
  PROCEDURE :: GET_DIMS => FIELD_3LM_GET_DIMS
  ...
  PROCEDURE :: CRC64 => FIELD_3LM_CRC64
#ifdef __PGI
...
!   thread has moved them meanwhile. And if they are still not, then they are moved.
  ...
  INTEGER*8 FUNCTION FIELD_3LM_CRC64 (SELF) RESULT (ICRC)
    CLASS(FIELD_3LM) :: SELF
    LOGICAL(KIND=JPLM), POINTER :: PTR(:,:,:)
    LOGICAL(KIND=JPLM), ALLOCATABLE :: ZZ(:,:,:)
    INTEGER*8 :: ILEN
    INTEGER(KIND=JPIM) :: J1,J2,J3
  ...
  SUBROUTINE FIELD_3LM_SYNC_DEVICE_WRONLY (SELF, QUEUE)
    CLASS(FIELD_3LM) :: SELF
    INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
    LOGICAL(KIND=JPLM), POINTER :: PPTR(:,:,:)

  END SUBROUTINE FIELD_3LM_SYNC_DEVICE_WRONLY
